...
def f5():
	...
	if(cal_window_ent_name.get()== "" or cal_window_ent_age.get()== "" or cal_window_ent_phone.get()== "" or cal_window_ent_height.get()=="" or cal_window_ent_weight.get()==""):
		...
		try:
			mydb = mysql.connector.connect(host="localhost", user="root", password="Lalit@2001")
...
def f9():
	...
	#E:\mysql\Project\BMI_Data
	
	a = "Data_" + str(d2) + "_" + str(current_time) + ".csv "
	file_location = f"'E:/mysql/Project/BMI_Data/{ a }'" 
	try:
		mydb = mysql.connector.connect(host="localhost", user="root", password="Lalit@2001")
		mycursor = mydb.cursor()
		mycursor.execute("use BMI_Database")
...
splash.configure(background="gold")
splash.wm_attributes('-fullscreen','true')
msg=Label(splash,text="BMI\n by \nLalit", font=('calibri',110,'bold'),fg='black',bg="gold")
msg.pack()
splash.mainloop()
#======================================================================================================================================================
root=Tk()
...
image1=PhotoImage(file=r"E:\mysql\Project\lalit.gif")
